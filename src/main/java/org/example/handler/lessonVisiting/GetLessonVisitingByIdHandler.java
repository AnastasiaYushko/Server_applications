...
public class GetLessonVisitingByIdHandler implements IHandler {
    ...
    public String handler(Object jsonRequest) throws JsonProcessingException {
        ...
        ResponseEntity<GetLessonVisitingByIdResponse> getLessonVisitingResponse = LessonVisitingController.getLessonVisitingById((GetLessonVisitingByIdRequest) jsonRequest);
